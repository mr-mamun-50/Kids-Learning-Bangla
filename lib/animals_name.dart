...
class AnimalsName extends StatefulWidget {
  ...
  @override
  _AnimalsNameState createState() => _AnimalsNameState();
}

class _AnimalsNameState extends State<AnimalsName> {
  var images = [
    'images/Animals/tiger.webp',
    'images/Animals/lion.jpg',
    'images/Animals/Elephant.jpg',
    'images/Animals/horin.jpg',
    'images/Animals/cow.jpg',
    'images/Animals/mohish.jpg',
    'images/Animals/cat.jpg',
    'images/Animals/dog.jpg'
  ];
  var names = ['বাঘ', 'সিংহ', 'হাতি', 'হরিণ', 'গরু', 'মহিষ', 'বিড়াল', 'কুকুর'];
  int index = 0;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('images/animal.jpg'),
                  fit: BoxFit.fill,
